    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                top: SizeConfig.screenHeight *
                    0.005), // Reduced vertical padding
            child: Column(
          ...
          Padding(
            padding:
                EdgeInsets.symmetric(vertical: SizeConfig.screenHeight * 0.015),
          ...
          Padding(
            // Optional adjustment if desired
            padding: EdgeInsets.only(right: SizeConfig.screenWidth * 0.02),
            child: Text(widget.caloriesBurned,
                style: Theme.of(context).textTheme.titleLarge),
          ),
        ],
      ),
